...
public class Testgetpicture1 {
    private static String index = "http://www.jj20.com/bz/nxxz/";
    private static String tag = "list_7_";
    private static int k = 46;
    private static String src = "E:\\aaa\\娟娟壁纸\\美女\\";
...
//        //匹配进分类图片的组的内部，得到组的url
    ...
    public static void download(List<String> pictureurl,String filesrc) {
        ...
        for (String src : pictureurl) {
            try {
                String finally_file_src=filesrc + i+".jpg";
                URL url = new URL(src);
