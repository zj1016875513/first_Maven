...
public class mappartitons_test1 {
    public static void main(String[] args) {
        ...
        for (String s : collect) {
            ...
            Count_List(jsc,path,s,result);
        }
        jsc.parallelize(result).mapToPair(x->x).reduceByKey((a,b)->a+b).coalesce(1).saveAsTextFile("Spark/output/mapPartiton");
    }

    private static void Count_List(JavaSparkContext jsc,String path,String s,ArrayList<Tuple2<String, Long>> result) {
